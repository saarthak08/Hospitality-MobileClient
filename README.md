...
- Request for appointment booking and track the appoitment status.
...
## Note:
- In order to build this mobile application, following things need to be done:
